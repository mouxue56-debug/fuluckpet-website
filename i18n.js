...
const translations = {
  ...
  ja: {
    ...
    // Story Card Generator V2 — Conversational Wizard
    'story.title': 'うちの子ストーリーカード',
    'story.subtitle': '出会いの瞬間を、世界にひとつのカードに。',
    'story.sampleTitle': 'こんなカードが作れます',
    'story.start': 'カードを作る',
    // Step 1 — Photo
    'story.step1Prompt': 'まず、お気に入りの1枚を見せて！📸',
    'story.step1Sub': '猫ちゃんの写真をアップロードしてね。AIが毛色や特徴を読み取るよ。',
    'story.photoClick': 'タップして写真を選ぶ',
    'story.photoChange': 'タップして写真を変更',
    'story.analyzing': 'AIが分析中...',
    'story.next': '次へ',
    'story.back': '戻る',
    // Step 2 — Name & Gender
    'story.step2Prompt': '素敵な子！名前を教えて 🐱',
    'story.step2Sub': 'お迎えした猫ちゃんのお名前と性別を選んでね。',
    'story.nameHint': '例：ゆき、モカ、レオ',
    'story.genderMale': '男の子',
    'story.genderFemale': '女の子',
    // Step 3 — Color & Date
    'story.step3Prompt': '毛色を確認してね 🎨',
    'story.step3Sub': 'AIが検出した毛色を確認して、お迎え日も教えてね。',
    'story.colorBrownTabby': 'ブラウンタビー',
    'story.colorSilverTabby': 'シルバータビー',
    'story.colorGoldenTabby': 'ゴールデンタビー',
    'story.colorBlue': 'ブルー（灰色系）',
    'story.colorWhite': 'ホワイト',
    'story.colorCream': 'クリーム',
    'story.colorRed': 'レッド（赤茶系）',
    'story.colorBlack': 'ブラック',
    'story.colorNeva': 'ネヴァマスカレード',
    'story.colorOther': 'その他',
    'story.date': '🏠 お迎え日',
    // Step 4 — Pets at Home
    'story.step4Prompt': 'おうちに兄弟はいる？ 🏠',
    'story.step4Sub': '他のペットを教えてね（複数選択OK）',
    'story.pet1Cat': '先住猫1匹',
    ...
    'story.skip': 'スキップ >',
    // Step 5 — Traits & Story
    'story.step5Prompt': '最後に、性格やエピソードを教えて 💕',
    'story.step5Sub': 'スキップしても大丈夫！AIが写真からいい感じに仕上げるよ。',
    'story.generateFinal': '🎉 ストーリーカードを作る！',
    'story.skipGenerate': 'ストーリーなしで作る',
    // Loading & Result
  ...
  en: {
    ...
    'story.subtitle': 'Turn your special moment into a one-of-a-kind card.',
    'story.sampleTitle': 'Cards you can create',
    'story.start': 'Create a Card',
    // Step 1 — Photo
    'story.step1Prompt': 'First, show me your favorite shot! 📸',
    'story.step1Sub': 'Upload your cat\'s photo. AI will detect the coat color and features.',
    'story.photoClick': 'Tap to choose a photo',
    'story.photoChange': 'Tap to change photo',
    'story.analyzing': 'AI analyzing...',
    'story.next': 'Next',
    'story.back': 'Back',
    // Step 2 — Name & Gender
    'story.step2Prompt': 'What a cutie! What\'s their name? 🐱',
    'story.step2Sub': 'Tell us your cat\'s name and gender.',
    'story.nameHint': 'e.g. Yuki, Mocha, Leo',
    'story.genderMale': 'Boy',
    'story.genderFemale': 'Girl',
    // Step 3 — Color & Date
    'story.step3Prompt': 'Confirm the coat color 🎨',
    'story.step3Sub': 'Check the AI-detected color and tell us the adoption date.',
    'story.colorBrownTabby': 'Brown Tabby',
    'story.colorSilverTabby': 'Silver Tabby',
    'story.colorGoldenTabby': 'Golden Tabby',
    'story.colorBlue': 'Blue (Gray)',
    'story.colorWhite': 'White',
    'story.colorCream': 'Cream',
    'story.colorRed': 'Red (Auburn)',
    'story.colorBlack': 'Black',
    'story.colorNeva': 'Neva Masquerade',
    'story.colorOther': 'Other',
    'story.date': '🏠 Adoption Date',
    // Step 4 — Pets at Home
    'story.step4Prompt': 'Any siblings at home? 🏠',
    'story.step4Sub': 'Tell us about other pets (multiple OK)',
    ...
    'story.skip': 'Skip >',
    // Step 5 — Traits & Story
    'story.step5Prompt': 'Finally, share their personality or a story 💕',
    'story.step5Sub': 'Feel free to skip! AI will craft a lovely card from the photo.',
    'story.generateFinal': '🎉 Create Story Card!',
    'story.skipGenerate': 'Create without a story',
    // Loading & Result
  ...
  zh: {
    ...
    // Story Card Generator V2 — Conversational Wizard
    'story.title': '我家猫咪故事卡',
    'story.subtitle': '把相遇的瞬间，做成独一无二的卡片。',
    'story.sampleTitle': '可以制作这样的卡片',
    'story.start': '开始制作',
    // Step 1 — Photo
    'story.step1Prompt': '先给我看看你最爱的一张！📸',
    'story.step1Sub': '上传猫咪照片，AI会自动识别毛色和特征。',
    'story.photoClick': '点击选择照片',
    'story.photoChange': '点击更换照片',
    'story.analyzing': 'AI识别中...',
    'story.next': '下一步',
    'story.back': '返回',
    // Step 2 — Name & Gender
    'story.step2Prompt': '好可爱！叫什么名字？🐱',
    'story.step2Sub': '告诉我猫咪的名字和性别。',
    'story.nameHint': '例：雪球、摩卡、Leo',
    'story.genderMale': '男孩',
    'story.genderFemale': '女孩',
    // Step 3 — Color & Date
    'story.step3Prompt': '确认一下毛色吧 🎨',
    'story.step3Sub': '确认AI识别的毛色，再告诉我迎接日期。',
    'story.colorBrownTabby': '棕虎斑',
    'story.colorSilverTabby': '银虎斑',
    'story.colorGoldenTabby': '金虎斑',
    'story.colorBlue': '蓝色（灰色系）',
    'story.colorWhite': '白色',
    'story.colorCream': '奶油色',
    'story.colorRed': '红色（红棕系）',
    'story.colorBlack': '黑色',
    'story.colorNeva': '涅瓦色',
    'story.colorOther': '其他',
    'story.date': '🏠 迎接日期',
    // Step 4 — Pets at Home
    'story.step4Prompt': '家里有其他小伙伴吗？🏠',
    'story.step4Sub': '告诉我家里的其他宠物（可多选）',
    'story.pet1Cat': '1只原住猫',
    ...
    'story.skip': '跳过 >',
    // Step 5 — Traits & Story
    'story.step5Prompt': '最后说说性格或小故事吧 💕',
    'story.step5Sub': '跳过也没关系！AI会根据照片生成精彩内容。',
    'story.generateFinal': '🎉 生成故事卡！',
    'story.skipGenerate': '不写故事直接生成',
    // Loading & Result

...
const translations = {
  ...
  ja: {
    ...
    'faqPage.a.faq_2': '見学は完全予約制です。ご希望の日時は予約ページまたはLINEからお知らせください。平日・土日いずれも対応可能です。見学時間は約1〜2時間を目安にしてください。',
  ...
  en: {
    ...
    'faqPage.a.faq_2': 'Visits are by appointment only. Please share your preferred date and time through the booking page or LINE. Weekdays and weekends are available. Please allow about 1–2 hours for your visit.',
  ...
  zh: {
    ...
    'faqPage.a.faq_2': '参观采用完全预约制。请通过预约页面或 LINE 告知希望的日期和时间。平日和周末均可，每次参观请预留约 1〜2 小时。',

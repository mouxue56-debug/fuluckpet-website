...
const translations = {
  ...
  ja: {
    ...
    'nav.grooming': '猫のシャンプー・基本ケア',
    'nav.dogServices': '犬のお預かり・基本ケア',
    'nav.naming': '子猫の名前ツール',
    'nav.guide': 'お迎えガイド',
    'nav.blog': '知識ライブラリ',
  ...
  en: {
    ...
    'nav.grooming': 'Cat Wash & Basic Care',
    'nav.dogServices': 'Dog Boarding & Basic Care',
  ...
  zh: {
    ...
    'nav.reviews': '客户评价',
    'nav.boarding': '宠物寄养',
    'nav.grooming': '猫咪洗护·基础护理',
    'nav.dogServices': '犬类寄养·基础护理',
    'nav.naming': '幼猫起名工具',
    'nav.guide': '接猫指南',
    'nav.blog': '知识库',

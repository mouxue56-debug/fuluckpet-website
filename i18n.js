...
const translations = {
  ...
  ja: {
    ...
    'nav.faq': 'よくある質問',
    'nav.group.pets': 'ペット',
    'nav.group.services': 'サービス・商品',
    'nav.group.breed': 'サイベリアン',
    'nav.group.adoption': 'ご相談・予約',
    ...
    'hero.awardProof.current': '2026年上半期 大阪府 第1位',
    'hero.awardProof.title': '7期連続受賞',
    'hero.awardProof.national': '全国 第1位 1期',
    'hero.awardProof.osaka': '大阪府 第1位 5期',
    'hero.awardProof.detail': '公式プレート14件｜サイベリアンブリーダー・お客様評価',
    'hero.awardProof.cta': '受賞歴を見る',
    'hero.title1': '家族になる、',
    'hero.title2': 'しあわせな出会い。',
    'hero.subtitle': '大阪のサイベリアン専門キャッテリー。<br>低アレルゲン傾向で、家庭に馴染む穏やかな性格の子猫をお届けします。',
    'hero.cta1': '子猫を見る',
    'hero.cta2': '見学を予約する',
    'hero.stat1': 'お客様評価',
    'hero.stat2': 'レビュー',
    ...
    'obi.graduates': 'これまでのお迎え実績',
    'obi.all': '親猫全頭',
    'obi.tested': '遺伝子検査済み',
    'chip.hypoallergenic': '低アレルゲン傾向のサイベリアン',
    'chip.mix': 'ミックス・健やか志向',
    'chip.adult': '成猫・すぐにお迎え可',
    'chip.neutered': '去勢・避妊済み',
    ...
    // §5.1 / §6.1 — mix and adult entry sections (index.html #mix-choice / #adult-choice)
    'mix.title': 'ミックス（サイベリアン × ブリティッシュショートヘア）という選択',
    'mix.body': '当キャッテリーのミックスは、サイベリアンとブリティッシュショートヘアの両親から生まれた子たちです。異なる品種を掛け合わせることで遺伝的多様性が高まり、特定の純血種に見られやすい遺伝性疾患のリスクが比較的低いとされています（個体差があり、健康を保証するものではありません）。欧州ではオランダなど一部の国で、極端な体型や遺伝性疾患リスクの高い純血種の繁殖を規制する動きが広がっており、ミックスを前向きに選ぶご家庭が増えています。サイベリアン譲りのふんわりとした被毛と、ブリティッシュ譲りの穏やかで人懐こい気質をあわせ持ち、価格も純血種よりお求めやすく設定しています。なお、ミックスのため血統書の発行はありません。',
    'mix.point1': '遺伝的多様性が高い',
    'mix.point2': '穏やかで人懐こい気質',
    'mix.point3': '純血種よりお求めやすい価格',
    'mix.point4': '血統書なし（ミックスのため）',
    'mix.link': 'ミックスの子猫を見る →',
    'adult.title': '成猫・若猫という選択 — 初めての方にこそ',
    'adult.body': '生後12ヶ月以上の成猫・若猫は、性格がすでに出来上がっており、「どんな子に育つか」が見えた状態でお迎えいただけます。子猫期特有の夜鳴きやいたずら、頻繁なワクチン通院の時期を過ぎているため、特別なケアは必要ありません。去勢・避妊済みの子は、発情期の鳴き声やマーキングの心配もありません。初めて猫を迎える方、日中お仕事で留守にされる方、落ち着いたパートナーを探している方におすすめです。そのままご家庭に迎えて、今日から一緒に暮らし始められます。',
    'adult.point1': '性格が出来上がっている',
    'adult.point2': '特別なケア不要',
    'adult.point3': '去勢・避妊済み（該当の子）',
    'adult.point4': '初心者・お留守番家庭向き',
    'adult.link': '子猫一覧で見る →',
    'about.registrationLineBtn': '見学・LINEで相談する',
    ...
    'kittens.heroSub': '新しいご家族を待っている子猫たちをご紹介します。料金は各子猫ページでご確認ください。',
    'diary.title': '猫舎日記',
    ...
    'kittens.sort': '並び替え:',
    'kittens.priceRange': '料金は子猫ごとに異なります。各子猫ページの最新情報をご確認ください。',
    ...
    'flow.s2.desc': 'LINEビデオ通話で事前相談・オンライン見学ができます。契約前には登録事業所へお越しいただき、子猫の現物確認と対面説明を行います。',
    'flow.s3.title': 'ご成約',
    ...
    'faq.q2': '見学は予約制ですか？',
    'faq.a2': '見学は完全予約制です。ご希望の日時は予約ページまたはLINEからお知らせください。平日・土日いずれも対応可能です。見学時間は約30分〜1時間を目安にしてください。',
    'faq.q3': '遠方に住んでいますが、お迎えは可能ですか？',
    'faq.a3': 'はい、全国へのお届けが可能です。動物愛護管理法により、ご契約は当キャッテリーの登録事業所（大阪市城東区東中浜2-6-23）で子猫の現物確認と対面説明を一度行ったうえで成立します。ご契約後は、空輸・陸送（空港お届けなど）でお届けできます。遠方の方は、LINEビデオ通話での事前相談・オンライン見学をご利用のうえ、ご契約時に一度ご来舎ください。配送費用は料金ガイドをご覧ください。',
    'faq.q4': '子猫の価格帯を教えてください。',
    'faq.a4': '料金は子猫ごとに異なります。各子猫ページの最新情報をご確認いただくか、LINEでお問い合わせください。',
    ...
    'faq.a6': 'はい、サイベリアンを中心に、ブリティッシュショートヘア・ブリティッシュロングヘア、サイベリアン×ブリティッシュのミックスも取り扱っております。過去にラグドールの繁育実績もございますが、現在は繁育しておりません。ご希望の猫種がございましたらお問い合わせください。',
    ...
    'faqPage.a.faq_2': '見学は完全予約制です。ご希望の日時は予約ページまたはLINEからお知らせください。平日・土日いずれも対応可能です。見学時間は約30分〜1時間を目安にしてください。',
    'faqPage.q.faq_3': '遠方に住んでいますが、お迎えは可能ですか？',
    'faqPage.a.faq_3': 'はい、全国へのお届けが可能です。動物愛護管理法により、ご契約は当キャッテリーの登録事業所（大阪市城東区東中浜2-6-23）で子猫の現物確認と対面説明を一度行ったうえで成立します。ご契約後は、空輸・陸送（空港お届けなど）でお届けできます。遠方の方は、LINEビデオ通話での事前相談・オンライン見学をご利用のうえ、ご契約時に一度ご来舎ください。配送費用は料金ガイドをご覧ください。',
    'faqPage.q.faq_4': '子猫の価格帯を教えてください。',
    'faqPage.a.faq_4': '料金は子猫ごとに異なります。各子猫ページの最新情報をご確認いただくか、LINEでお問い合わせください。',
    ...
    'faqPage.a.faq_6': 'はい、サイベリアンを中心に、ブリティッシュショートヘア・ブリティッシュロングヘア、サイベリアン×ブリティッシュのミックスも取り扱っております。過去にラグドールの繁育実績もございますが、現在は繁育しておりません。ご希望の猫種がございましたらお問い合わせください。',
    'faqPage.q.faq_7': 'ワクチン接種は済んでいますか？',
    'faqPage.a.faq_7': 'お引渡し前に月齢に応じた1回目のワクチン接種を済ませております。2回目以降は、お迎え後にかかりつけの動物病院で接種をお願いしております。ワクチン証明書もお渡しします。（ワクチン代10,000円は子猫価格とは別に申し受けます）',
    ...
    'faqPage.a.faq_12': '見学場所：大阪市城東区東中浜2-6-23（最寄り：Osaka Metro 緑橋駅）です。お車でのお越しも可能です。完全予約制のため、事前にLINEまたは予約ページからご連絡ください。',
    ...
    'faqPage.a.faq_18': 'やむを得ない事情がある場合はご相談ください。ただし、お客様のご都合によるキャンセルの場合、お支払いいただいた予約金（50,000円）はご返金いたしかねますのでご了承ください。詳しくはご契約時にご説明いたします。',
    'faqPage.q.faq_19': '支払い方法は何がありますか？',
    'faqPage.a.faq_19': '現金払い・銀行振込（三井住友銀行／ゆうちょ銀行）に対応しております。その他のお支払い方法をご希望の場合は、ご契約時にご案内いたしますので、LINEでお問い合わせください。',
    ...
    'faqPage.q.faq_25': '生体保証（健康保証）はありますか？',
    'faqPage.a.faq_25': 'はい、無料の生体保証をご用意しております。お引き渡し日から30日以内に先天性疾患が原因で亡くなった場合、同猫種の子猫をお渡しいたします（治療費や金銭でのご返金は保証の対象外です）。ご利用には、当日中のご連絡と、獣医師による死亡診断書・検査結果原本のご提出が必要です。事故・感染症予防接種による体調不良、飼育環境に起因する体調不良など、一部の事由は保証の対象外となります。詳細はご契約時にご説明いたします。',
    'faqPage.q.faq_26': 'ミックスの子猫はどう違いますか？',
    'faqPage.a.faq_26': '当キャッテリーのミックスは、サイベリアンとブリティッシュショートヘアの両親から生まれた子で、異なる品種の掛け合わせにより遺伝的多様性が高まり、特定の純血種に見られやすい遺伝性疾患のリスクが比較的低いとされています（個体差があり、健康を保証するものではありません）。サイベリアン譲りのふんわりとした被毛とブリティッシュ譲りの穏やかで人懐こい気質をあわせ持ち、価格も純血種よりお求めやすく設定しています。なお、ミックスのため血統書の発行はありません。',
    'faqPage.q.faq_27': '成猫・若猫もお迎えできますか？',
    'faqPage.a.faq_27': '生後12ヶ月以上の成猫・若猫も直接お迎えいただけます。性格がすでに出来上がっており、子猫期特有の夜鳴きやいたずら、頻繁なワクチン通院の時期を過ぎているため特別なケアは不要です（去勢・避妊済みの子は発情期の心配もありません）。初めて猫を迎える方や日中お仕事で留守にされる方にもおすすめで、そのままご家庭に迎えて今日から一緒に暮らし始められます。',
    ...
    'visit.access': 'アクセス',
    'visit.address': '大阪市城東区東中浜2-6-23',
    'visit.addressNote': '最寄り：Osaka Metro 緑橋駅／完全予約制',
    'visit.info': '見学について',
    'visit.v1': '完全予約制（前日までにご連絡ください）',
    'visit.v2': '現地見学 ・ LINE事前相談に対応',
    ...
    'visit.lawNotice': 'LINEビデオ通話は事前相談・オンライン見学として利用できますが、契約前には登録事業所で子猫の現物確認と対面説明が必要です。',
    ...
    'law.text': '法律の規定により、ご購入前にキャッテリーにお越しいただき、子猫と対面していただく必要がございます。対面販売・対面説明・現物確認は法律で義務付けられております。',

    // Footer
    'footer.navTitle': 'ナビゲーション',
    'footer.legalTitle': '動物取扱業表示',
    'footer.legalFullLink': '動物取扱業に関する表示の全文 →',
    'footer.pagesTitle': '詳しく見る',
    'footer.tagline': 'サイベリアン｜大阪・福楽キャッテリー',
    'footer.lawNotice': '契約前に登録事業所での現物確認と対面説明が必要です。LINEビデオ通話は事前相談・オンライン見学としてご利用いただけます。',
    ...
    'awards.timeline.title': '2023年から続く受賞歴',
    'awards.timeline.summary': '2023年上半期から2026年上半期まで7期連続、公式プレート14件。サイベリアンブリーダーのお客様評価として、大阪府・関西／近畿・全国で評価されています。',
    'awards.timeline.method': 'みんなの子猫ブリーダーが、各期間により多くのお客様評価を獲得したブリーダーを表彰するものです。',
    'awards.timeline.category': 'サイベリアンブリーダー',
    'awards.timeline.scope.osaka': '大阪府',
    'awards.timeline.scope.kansai': '関西・近畿地域',
    'awards.timeline.scope.national': '全国',
    'awards.timeline.rank.1': 'お客様評価 第1位',
    'awards.timeline.rank.2': 'お客様評価 第2位',
    'awards.timeline.rank.3': 'お客様評価 第3位',
    'awards.timeline.2023.h1': '2023年 上半期',
    'awards.timeline.2023.h2': '2023年 下半期',
    'awards.timeline.2024.h1': '2024年 上半期',
    'awards.timeline.2024.h2': '2024年 下半期',
    'awards.timeline.2025.h1': '2025年 上半期',
    'awards.timeline.2025.h2': '2025年 下半期',
    'awards.timeline.2026.h1': '2026年 上半期',
    'gallery.filterAll': 'すべて',
    'gallery.filterSiberian': 'サイベリアン',
    'gallery.filterBritish': 'ブリティッシュ',
    'gallery.filterRagdoll': 'ラグドール（過去の実績）',
    'gallery.ragdollNote': '※過去にラグドールの繁育実績がありますが、現在は繁育しておりません。',
    ...
    // Booking Page
    'booking.title': '見学予約',
    'booking.subtitle': '現地見学またはLINEでの事前相談をご予約ください。\nお気軽にどうぞ。',
    ...
    'booking.methodVideo': 'LINEビデオ通話（事前相談）',
    ...
    'booking.infoVideo': '現地見学・LINE事前相談に対応',
    ...
    'guide.cta.sub1': 'LINEビデオで事前相談もできます',
  ...
  en: {
    ...
    'nav.faq': 'FAQ',
    'nav.group.pets': 'Pets',
    'nav.group.services': 'Services & Shop',
    'nav.group.breed': 'Siberians',
    'nav.group.adoption': 'Plan & Book',
    'nav.group.cattery': 'Cattery',
    'nav.shop': 'Shop',
    'nav.more': 'More',
    'nav.siberian': 'About Siberians',
    'nav.diary': 'Cattery Journal',
    ...
    'nav.boarding': 'Cat Boarding',
    'nav.grooming': 'Cat Care',
    ...
    'hero.awardProof.current': 'H1 2026 · No. 1 in Osaka Prefecture',
    'hero.awardProof.title': 'Awarded 7 consecutive periods',
    'hero.awardProof.national': 'Japan No. 1 · 1 period',
    'hero.awardProof.osaka': 'Osaka No. 1 · 5 periods',
    'hero.awardProof.detail': '14 official plaques · Siberian breeder customer ratings',
    ...
    'obi.graduates': 'Kittens welcomed by families',
    'obi.all': 'All parent cats',
    'obi.tested': 'Genetically tested',
    'chip.hypoallergenic': 'Siberian · lower-allergen tendency',
    'chip.mix': 'Mix · genetic diversity',
    'chip.adult': 'Adult · ready to go home',
    'chip.neutered': 'Neutered/Spayed',
    ...
    'kittens.heroSub': 'Meet the kittens waiting for their new families. Check each kitten page for current details.',
    'diary.title': 'Cattery Journal',
    ...
    'kittens.sort': 'Sort:',
    'kittens.priceRange': 'Prices vary by kitten. Please check each kitten page for the latest details.',
    ...
    'flow.s2.desc': 'You can use a LINE video call for preliminary consultation and online viewing. Before signing a contract, you must visit our registered premises to see the kitten and receive an in-person explanation.',
    ...
    'faq.a6': "Yes — alongside our specialty Siberians, we also breed British Shorthairs, British Longhairs and Siberian × British Shorthair mixes. We have past breeding experience with Ragdolls but no longer breed them. Please ask if you are interested in a specific breed.",
    ...
    'faqPage.a.faq_2': 'Visits are by appointment only. Please share your preferred date and time through the booking page or LINE. Weekdays and weekends are available. Please allow about 30 minutes to 1 hour for your visit.',
    'faqPage.q.faq_3': 'I live far away. Can I still adopt?',
    'faqPage.a.faq_3': "Yes, we can deliver nationwide. Under Japan's Animal Welfare Act, the sales contract is concluded once, in person, at our registered premises (2-6-23 Higashinakahama, Joto-ku, Osaka), after you have seen the kitten and received the required explanation. After the contract, we can deliver by air or ground (airport hand-over available). Customers living far away are welcome to use a LINE video call for pre-consultation and an online viewing, then visit us once to sign. See the price guide for delivery fees.",
    'faqPage.q.faq_4': 'What is the price range?',
    'faqPage.a.faq_4': 'Prices vary by kitten. Please check the latest details on each kitten page or contact us on LINE.',
    ...
    'faqPage.a.faq_6': "Yes — alongside our specialty Siberians, we also breed British Shorthairs, British Longhairs and Siberian × British Shorthair mixes. We have past breeding experience with Ragdolls but no longer breed them. Please ask if you are interested in a specific breed.",
    'faqPage.q.faq_7': 'Are vaccinations completed?',
    'faqPage.a.faq_7': 'The first vaccination (age-appropriate) is completed before handover. The second and subsequent vaccines should be given at your local vet after adoption. A vaccination certificate is included. (A separate vaccination fee of \u00a510,000 applies in addition to the kitten price.)',
    ...
    'faqPage.a.faq_18': "Please contact us if there are unavoidable circumstances. For cancellations at the customer's discretion, however, the \u00a550,000 reservation deposit cannot be refunded — please understand. Details are explained at contract time.",
    'faqPage.q.faq_19': 'What payment methods do you accept?',
    'faqPage.a.faq_19': 'We accept cash and bank transfer (Sumitomo Mitsui Banking Corporation / Japan Post Bank). If you would like to use another payment method, please ask us on LINE and we will confirm the details when you sign.',
    ...
    'visit.access': 'Access',
    'visit.address': '2-6-23 Higashinakahama, Joto-ku, Osaka',
    'visit.addressNote': 'Nearest station: Osaka Metro Midoribashi / by appointment only',
    'visit.info': 'About Visits',
    'visit.v1': 'By appointment only (contact us at least one day prior)',
    'visit.v2': 'On-site visits & preliminary LINE consultations',
    ...
    'visit.lawNotice': 'LINE video calls are available for preliminary consultations and online viewing, but before signing a contract you must visit the registered premises to see the kitten and receive an in-person explanation.',
    ...
    'footer.legalFullLink': 'Full animal-handling registration details \u2192',
    'footer.pagesTitle': 'Learn More',
    'footer.tagline': 'Siberian Cat | Fuluck Cattery, Osaka',
    'footer.lawNotice': 'Before signing a contract, you must visit the registered premises to see the kitten and receive an in-person explanation. LINE video calls are for preliminary consultations and online viewing.',
    ...
    'awards.timeline.title': 'Recognition since 2023',
    'awards.timeline.summary': 'Fourteen official plates across seven consecutive half-year periods, from the first half of 2023 through the first half of 2026, recognizing Siberian breeder customer reviews in Osaka, Kansai/Kinki and nationwide.',
    'awards.timeline.method': 'Minna no Koneko Breeder presents these awards to breeders who received more customer reviews during each period.',
    'awards.timeline.category': 'Siberian breeder',
    'awards.timeline.scope.osaka': 'Osaka Prefecture',
    'awards.timeline.scope.kansai': 'Kansai/Kinki region',
    'awards.timeline.scope.national': 'Nationwide',
    'awards.timeline.rank.1': 'No. 1 for customer reviews',
    'awards.timeline.rank.2': 'No. 2 for customer reviews',
    'awards.timeline.rank.3': 'No. 3 for customer reviews',
    'awards.timeline.2023.h1': 'First half of 2023',
    'awards.timeline.2023.h2': 'Second half of 2023',
    'awards.timeline.2024.h1': 'First half of 2024',
    'awards.timeline.2024.h2': 'Second half of 2024',
    'awards.timeline.2025.h1': 'First half of 2025',
    'awards.timeline.2025.h2': 'Second half of 2025',
    'awards.timeline.2026.h1': 'First half of 2026',
    'gallery.filterAll': 'All',
    'gallery.filterSiberian': 'Siberian',
    'gallery.filterBritish': 'British',
    'gallery.filterRagdoll': 'Ragdoll (past breeding record)',
    'gallery.ragdollNote': 'Note: we have past breeding experience with Ragdolls, but we no longer breed them.',
    ...
    'trust.rating': '5.00 Rating / 100+ Reviews',
    ...
    'booking.subtitle': 'Book an on-site visit or a preliminary LINE consultation.\nFeel free to reach out!',
    ...
    'booking.methodVideo': 'LINE Video Call (Preliminary)',
    ...
    'booking.infoVideo': 'On-site visits & preliminary LINE consultation',
    ...
    'guide.cta.sub1': 'Preliminary LINE video consultation available',
  ...
  zh: {
    ...
    'nav.faq': '常见问题',
    'nav.group.pets': '宠物',
    'nav.group.services': '服务与商品',
    'nav.group.breed': '西伯利亚猫',
    'nav.group.adoption': '咨询与预约',
    ...
    'hero.awardProof.current': '2026年上半年 大阪府第1名',
    'hero.awardProof.title': '连续7期获奖',
    'hero.awardProof.national': '日本全国第1名・1期',
    'hero.awardProof.osaka': '大阪府第1名・5期',
    'hero.awardProof.detail': '14枚官方奖牌｜西伯利亚猫繁育者・客户评价',
    ...
    'obi.graduates': '历年迎接幼猫实绩',
    'obi.all': '全部亲猫',
    'obi.tested': '已做基因检测',
    'chip.hypoallergenic': '低致敏倾向的西伯利亚猫',
    'chip.mix': '混血・遗传多样',
    'chip.adult': '成猫・可直接接回家',
    'chip.neutered': '已绝育',
    ...
    // §5.1 / §6.1 — mix and adult entry sections (index.html #mix-choice / #adult-choice)
    'mix.title': '混血猫（西伯利亚 × 英国短毛）这个选择',
    'mix.body': '本猫舍的混血猫由西伯利亚猫与英国短毛猫的父母所生。不同品种杂交提高了遗传多样性，通常认为特定纯种猫常见的遗传性疾病风险相对较低（存在个体差异，不构成健康保证）。在欧洲，荷兰等部分国家已开始限制极端体型或遗传病风险高的纯种繁育，越来越多家庭主动选择混血猫。我们的混血猫兼具西伯利亚猫柔软蓬松的被毛与英短温和亲人的性格，价格也比纯种幼猫更易入手。由于是混血，不附带血统证书。',
    'mix.point1': '遗传多样性高',
    'mix.point2': '性格温和亲人',
    'mix.point3': '价格更易入手',
    'mix.point4': '无血统证书（混血）',
    'mix.link': '查看混血幼猫 →',
    'adult.title': '成猫・青年猫 — 最适合新手的选择',
    'adult.body': '12 个月以上的成猫・青年猫性格已经定型，您能清楚知道接回家的是怎样的一只猫。它们已经度过幼猫期的夜间叫唤、调皮捣蛋和频繁疫苗就诊阶段，无需特殊照顾。已绝育的猫咪也不会有发情期的叫声和标记行为。特别适合第一次养猫的家庭、白天上班不在家的家庭，以及想要一位安静陪伴者的您。可以直接接回家，从今天开始一起生活。',
    'adult.point1': '性格已定型',
    'adult.point2': '无需特殊照顾',
    'adult.point3': '已绝育（标注的猫咪）',
    'adult.point4': '适合新手与上班族家庭',
    'adult.link': '查看全部幼猫 →',
    'about.registrationLineBtn': '预约见学・LINE 咨询',
    ...
    'kittens.heroSub': '为您介绍正在等待新家庭的猫咪们。最新信息请查看每只猫咪页面。',
    'diary.title': '猫舍日常',
    ...
    'kittens.sort': '排序：',
    'kittens.priceRange': '价格因猫咪而异。请查看每只猫咪页面的最新信息。',
    ...
    'flow.s2.desc': '可通过LINE视频通话进行前期咨询和线上看猫。签约前仍须到登记营业场所现场确认幼猫实物并接受面对面说明。',
    'flow.s3.title': '签订合同',
    ...
    'faq.q2': '参观需要预约吗？',
    'faq.a2': '参观采用完全预约制。请通过预约页面或 LINE 告知希望的日期和时间。平日和周末均可，每次参观请预留约 30 分钟至 1 小时。',
    'faq.q3': '我住得比较远，可以领养吗？',
    'faq.a3': '可以，我们支持全国配送。依据日本《动物爱护管理法》，买卖合同需在本猫舍的登记营业所（大阪市城东区东中浜2-6-23）当面确认幼猫并听取说明后签订一次。签约后可通过空运或陆运（含机场交接）送达。远方客户可先通过 LINE 视频进行咨询和线上见学，签约时来舍一次即可。配送费用请参阅价格指南。',
    'faq.q4': '幼猫的价格范围是多少？',
    'faq.a4': '价格因猫咪而异。请查看每只猫咪页面的最新信息，或通过 LINE 咨询。',
    'faq.q5': '领养后有售后支持吗？',
    'faq.a5': '有的，领养后可随时通过LINE咨询饮食、健康管理、训练等任何问题。我们提供终身支持。',
    'faq.q6': '除了西伯利亚猫还有其他猫种吗？',
    'faq.a6': '有的，以西伯利亚猫为主，同时也繁育英国短毛猫、英国长毛猫，以及西伯利亚×英国短毛的混血猫。布偶猫我们过去曾有繁育实绩，现在已不再繁育。如果您对特定猫种感兴趣，请告诉我们。',
    ...
    'faqPage.a.faq_2': '参观采用完全预约制。请通过预约页面或 LINE 告知希望的日期和时间。平日和周末均可，每次参观请预留约 30 分钟至 1 小时。',
    'faqPage.q.faq_3': '我住得比较远，可以领养吗？',
    'faqPage.a.faq_3': '可以，我们支持全国配送。依据日本《动物爱护管理法》，买卖合同需在本猫舍的登记营业所（大阪市城东区东中浜2-6-23）当面确认幼猫并听取说明后签订一次。签约后可通过空运或陆运（含机场交接）送达。远方客户可先通过 LINE 视频进行咨询和线上见学，签约时来舍一次即可。配送费用请参阅价格指南。',
    'faqPage.q.faq_4': '幼猫的价格范围是多少？',
    'faqPage.a.faq_4': '价格因猫咪而异。请查看每只猫咪页面的最新信息，或通过 LINE 咨询。',
    'faqPage.q.faq_5': '领养后有售后支持吗？',
    'faqPage.a.faq_5': '有的，领养后可随时通过LINE咨询饮食、健康、训练等任何问题。我们提供终身支持。',
    'faqPage.q.faq_6': '除了西伯利亚猫还有其他猫种吗？',
    'faqPage.a.faq_6': '有的，以西伯利亚猫为主，同时也繁育英国短毛猫、英国长毛猫，以及西伯利亚×英国短毛的混血猫。布偶猫我们过去曾有繁育实绩，现在已不再繁育。如果您对特定猫种感兴趣，请告诉我们。',
    'faqPage.q.faq_7': '是否已经接种疫苗？',
    'faqPage.a.faq_7': '交付前会按月龄完成第一针疫苗。第二针及以后请在领养后的本地宠物医院接种。我们会提供疫苗证明书。（疫苗费10,000日元另计，不含在幼猫价格内。）',
    ...
    'faqPage.a.faq_12': '见学地点：大阪市城东区东中浜2-6-23（最近车站：Osaka Metro 绿桥站）。可以自驾前来。因采用完全预约制，请提前通过LINE或预约页面联系我们。',
    ...
    'faqPage.a.faq_18': '如有不可避免的情况，请与我们商议。但因客户自身原因取消时，已支付的 50,000 日元预约金恕不退还，敬请谅解。具体内容将在签约时说明。',
    'faqPage.q.faq_19': '支持哪些支付方式？',
    'faqPage.a.faq_19': '支持现金支付与银行转账（三井住友银行／邮储银行）。如需使用其他支付方式，请通过 LINE 咨询，我们会在签约时告知详情。',
    ...
    'faqPage.q.faq_25': '幼猫有健康保证（生体保证）吗？',
    'faqPage.a.faq_25': '有的，我们提供免费的生体保证：若幼猫在交付之日起30天内因先天性疾病死亡，我们将补偿一只同品种的幼猫（该保证仅限换猫，不含治疗费或现金赔偿）。使用该保证需在当天联系我们，并提供兽医出具的死亡诊断书及检测报告原件。因意外、疫苗接种反应或饲养环境等原因造成的情况不在保证范围内。详细内容将在签约时说明。',
    'faqPage.q.faq_26': '混血幼猫有什么不同？',
    'faqPage.a.faq_26': '本猫舍的混血猫由西伯利亚猫与英国短毛猫的父母所生，不同品种杂交提高了遗传多样性，通常认为特定纯种猫常见的遗传性疾病风险相对较低（存在个体差异，不构成健康保证）。它们兼具西伯利亚猫柔软蓬松的被毛与英短温和亲人的性格，价格也比纯种幼猫更易入手。由于是混血，不附带血统证书。',
    'faqPage.q.faq_27': '可以领养成猫或青年猫吗？',
    'faqPage.a.faq_27': '可以，12个月以上的成猫・青年猫也可以直接接回家。它们性格已经定型，已经度过幼猫期的夜间叫唤、调皮捣蛋和频繁疫苗就诊阶段，无需特殊照顾（已绝育的猫咪也不必担心发情期）。特别适合第一次养猫或白天上班不在家的家庭，可以直接接回家，从今天开始一起生活。',
    ...
    'visit.access': '交通方式',
    'visit.address': '大阪市城东区东中浜2-6-23',
    'visit.addressNote': '最近车站：Osaka Metro 绿桥站／完全预约制',
    'visit.info': '关于参观',
    'visit.v1': '完全预约制（请至少提前一天联系）',
    'visit.v2': '支持现场参观与LINE前期咨询',
    ...
    'visit.bookBtn': '预约见学',
    'visit.delivery': '配送方式',
    'visit.lawNotice': 'LINE 视频通话可用于前期咨询和线上看猫，但签约前仍须到登记营业场所现场确认幼猫实物并接受面对面说明。',
    ...
    'footer.legalFullLink': '动物经营许可完整表示 →',
    'footer.pagesTitle': '了解更多',
    'footer.tagline': '西伯利亚猫｜大阪·福楽猫舍',
    'footer.lawNotice': '签约前须到登记营业场所现场确认幼猫实物并接受面对面说明。LINE视频通话仅用于前期咨询和线上看猫。',
    ...
    'awards.timeline.title': '始于 2023 年的获奖历程',
    'awards.timeline.summary': '从 2023 年上半年至 2026 年上半年，连续 7 个半年度获得 14 枚官方奖牌，均为西伯利亚猫繁育者客户评价奖，覆盖大阪府、关西／近畿地区及全国范围。',
    'awards.timeline.method': '“大家的子猫繁育者”按每个期间获得较多客户评价的繁育者颁发该奖项。',
    'awards.timeline.category': '西伯利亚猫繁育者',
    'awards.timeline.scope.osaka': '大阪府',
    'awards.timeline.scope.kansai': '关西／近畿地区',
    'awards.timeline.scope.national': '全国',
    'awards.timeline.rank.1': '客户评价 第 1 名',
    'awards.timeline.rank.2': '客户评价 第 2 名',
    'awards.timeline.rank.3': '客户评价 第 3 名',
    'awards.timeline.2023.h1': '2023年上半年',
    'awards.timeline.2023.h2': '2023年下半年',
    'awards.timeline.2024.h1': '2024年上半年',
    'awards.timeline.2024.h2': '2024年下半年',
    'awards.timeline.2025.h1': '2025年上半年',
    'awards.timeline.2025.h2': '2025年下半年',
    'awards.timeline.2026.h1': '2026年上半年',
    'gallery.filterAll': '全部',
    'gallery.filterSiberian': '西伯利亚猫',
    'gallery.filterBritish': '英国短毛猫',
    'gallery.filterRagdoll': '布偶猫（过去的繁育实绩）',
    'gallery.ragdollNote': '※布偶猫为过去的繁育实绩，现已不再繁育。',
    ...
    // Booking Page
    'booking.title': '预约参观',
    'booking.subtitle': '请预约现场参观或LINE前期咨询。\n欢迎随时联系我们！',
    ...
    'booking.methodVideo': 'LINE视频通话（前期咨询）',
    ...
    'booking.infoVideo': '支持现场参观与LINE前期咨询',
    ...
    'guide.cta.sub1': '可通过LINE视频进行前期咨询',
...
function initI18n() {
  ...
  // A ja-root page with a hand-baked /en/ + /zh/ sibling has hand-written Japanese body
  // copy that no dictionary covers. Translating in place would swap the chrome and leave
  // the article Japanese — one URL rendering in two languages. An explicit ?lang= goes to
  // the real sibling; a merely-remembered preference is left alone (nav.js agrees, see
  // currentLang()), so the reader gets a coherent Japanese page and a working switcher.
  if (!pathLang && activeLang && activeLang !== 'ja' && jaHasStaticSibling(rootPath)) {
    if (urlLang && translations[urlLang]) {
      window.location.replace('/' + urlLang + rootPath + (window.location.hash || ''));
      return;
    }
    activeLang = null;
  }

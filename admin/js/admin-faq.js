...
function seedDefaultFaq() {
  ...
  var defaults = [
    ...
    { id:'faq_2', order:2, category:'purchase', published:true,
      ...
      answer:{ ja:'見学は完全予約制です。ご希望の日時は予約ページまたはLINEからお知らせください。平日・土日いずれも対応可能です。見学時間は約30分〜1時間を目安にしてください。', en:'Visits are by appointment only. Please share your preferred date and time through the booking page or LINE. Weekdays and weekends are available. Please allow about 30 minutes to 1 hour for your visit.', zh:'参观采用完全预约制。请通过预约页面或 LINE 告知希望的日期和时间。平日和周末均可，每次参观请预留约 30 分钟至 1 小时。' } },
    ...
    { id:'faq_4', order:4, category:'purchase', published:true,
      ...
      answer:{ ja:'料金は子猫ごとに異なります。各子猫ページの最新情報をご確認いただくか、LINEでお問い合わせください。', en:'Prices vary by kitten. Please check the latest details on each kitten page or contact us on LINE.', zh:'价格因猫咪而异。请查看每只猫咪页面的最新信息，或通过 LINE 咨询。' } },
    ...
    { id:'faq_6', order:6, category:'general', published:true,
      ...
      answer:{ ja:'はい、サイベリアンを中心に、ブリティッシュショートヘア・ブリティッシュロングヘア、サイベリアン×ブリティッシュのミックスも取り扱っております。過去にラグドールの繁育実績もございますが、現在は繁育しておりません。ご希望の猫種がございましたらお問い合わせください。', en:'Yes — alongside our specialty Siberians, we also breed British Shorthairs, British Longhairs and Siberian × British Shorthair mixes. We have past breeding experience with Ragdolls but no longer breed them. Please ask if you are interested in a specific breed.', zh:'有的，以西伯利亚猫为主，同时也繁育英国短毛猫、英国长毛猫，以及西伯利亚×英国短毛的混血猫。布偶猫我们过去曾有繁育实绩，现在已不再繁育。如果您对特定猫种感兴趣，请告诉我们。' } }
  ];
  if (!faqBeginMutation()) return Promise.resolve(false);
  return Promise.resolve().then(function() {

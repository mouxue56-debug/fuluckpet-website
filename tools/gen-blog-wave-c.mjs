...
- 子猫の料金: 個体ごとに異なる。最新情報は各子猫ページで確認し、不明点はLINE公式で相談
...
各セクションで「番地・地図リンクは予約確定後にLINEでお送りします」を1〜2回明示する。`,
  },
  {
    ...
    title: '関西 vs 関東のサイベリアン購入｜お迎え条件・移動・選び方の違い',
    kw: 'サイベリアン 関西 関東 選び方',
    cat: 'breeder',
    tags: ['関西','関東','サイベリアン','お迎え','選び方'],
    angle: 'kansai_vs_kanto',
    body_guide: `
関西と関東でサイベリアンを迎える場合の違いを比較。
1. 料金の確認方法 — 地域だけで一律の価格帯を断定しない。福楽キャッテリーの料金は子猫ごとに異なるため、各子猫ページの最新情報を確認し、不明点はLINEで相談する
...
5. 強み4: 情報の透明性 — 各子猫ページで個体ごとの最新情報を案内し、不明点はLINEで確認できる
...
- 数字の捏造（検証済み事実にない価格帯や件数を出さない。子猫の料金は各子猫ページの最新情報へ案内する）

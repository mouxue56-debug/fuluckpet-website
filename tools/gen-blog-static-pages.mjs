...
// Locale-aware labels for the shared bottom CTA box + related-articles heading +
// bottom nav. Defaults to ja (byte-identical to the historical output). en/zh mirror
// exactly what the ja says — no new claims. Proper noun 福楽キャッテリー is kept as-is;
// badge NUMBERS (5.00 / 113 / 200+) are never translated.
const CTA_I18N = {
  ja: {
    relatedHeading: '関連記事',
    ...
    btnBook: '見学を予約する',
    btnLine: 'LINEで相談する',
    konekoLink: 'みんなの子猫ブリーダーで最新の子猫を見る',
    navBack: '記事一覧へ戻る',
    navKittens: '子猫を見る',
    navGuide: 'お迎えガイド',
    fixedAria: 'LINEでお問い合わせ',
    fixedLabel: '見学予約・ご相談',
    fixedCta: 'LINEで相談',
  },
  en: {
    ...
    btnList: 'View Available Kittens',
    btnBook: 'Book a Visit',
    btnLine: 'Chat on LINE',
    konekoLink: 'See our latest kittens on Minna no Koneko Breeder',
    navBack: 'Back to Articles',
    navKittens: 'View Kittens',
    navGuide: 'Adoption Guide',
...
function buildPage(art, lang = 'ja') {
  const T = CTA_I18N[lang] || CTA_I18N.ja;
...
<head>
  ...
  <link rel="stylesheet" href="/style.css?v=20260823a">
...
${body}
    ...
    <div class="blog-cta-box">
      ...
      <h3 class="blog-cta-title">${T.ctaTitle}</h3>
      <div style="display:flex;gap:8px;justify-content:center;flex-wrap:wrap;margin:0 0 16px;font-size:0.82rem;color:#5A7A7A;">
        <span style="background:#fff;border:1px solid #e8f5f0;border-radius:20px;padding:4px 14px;"><i class="ico ico-star" aria-hidden="true"></i> ${T.badgeReviews}</span>
        <span style="background:#fff;border:1px solid #e8f5f0;border-radius:20px;padding:4px 14px;"><i class="ico ico-trophy" aria-hidden="true"></i> ${T.badgeRank}</span>
        <span style="background:#fff;border:1px solid #e8f5f0;border-radius:20px;padding:4px 14px;"><i class="ico ico-paw-print" aria-hidden="true"></i> ${T.badgeGrads}</span>
      </div>
      <p class="blog-cta-text">${T.ctaText}</p>
      <div class="blog-cta-buttons">
        <a href="/kittens.html" class="blog-cta-btn blog-cta-btn-primary"><i class="ico ico-paw-print" aria-hidden="true"></i> ${T.btnList}</a>
        <a href="/booking.html" class="blog-cta-btn blog-cta-btn-primary"><i class="ico ico-calendar-check" aria-hidden="true"></i> ${T.btnBook}</a>
        <a href="https://page.line.me/915hnnlk?oat__id=5765672&openQrModal=true" class="blog-cta-btn blog-cta-btn-line" target="_blank" rel="noopener"><i class="ico ico-message-circle" aria-hidden="true"></i> ${T.btnLine}</a>
      </div>
      <p style="margin:16px 0 0;font-size:0.85rem;"><a href="https://www.koneko-breeder.com/breeder_c995680.html" target="_blank" rel="noopener" style="color:#5BC4A8;font-weight:500;"><i class="ico ico-trophy" aria-hidden="true"></i> ${T.konekoLink}</a></p>
    </div>

    <div class="blog-nav-bottom">
      <a href="/blog.html" class="blog-nav-link"><i class="ico ico-book-open" aria-hidden="true"></i> ${T.navBack}</a>
      <a href="/kittens.html" class="blog-nav-link"><i class="ico ico-cat" aria-hidden="true"></i> ${T.navKittens}</a>
      <a href="/guide/" class="blog-nav-link"><i class="ico ico-book-open" aria-hidden="true"></i> ${T.navGuide}</a>
    </div>
  </article>
  ...
  <a href="https://page.line.me/915hnnlk?oat__id=5765672&openQrModal=true" class="fixed-line" data-cta="line" aria-label="${T.fixedAria}" target="_blank" rel="noopener">
    ...
    <span class="fixed-line-content"><span class="fixed-line-label" data-i18n="header.telLabel">${T.fixedLabel}</span><span class="fixed-line-cta" data-i18n="cta.line">${T.fixedCta}</span></span>
  </a>
  ...
  <script src="/i18n.js?v=20260823a"></script>
  <script src="/blog/blog-i18n.js?v=20260710b"></script>
  <script src="/script.js?v=20260823a"></script>

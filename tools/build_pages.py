...
LANDING_FAQ = [
 ("大阪・関西でサイベリアンの子猫を迎えるには？", "完全予約制の見学（対面またはLINEビデオ通話）から始まります。LINEまたは予約フォームでご連絡いただき、子猫との相性を確認のうえお迎えいただけます。関西全域に加え全国へのお届けも可能です。"),
 ("サイベリアンの価格帯は？", "猫種・血統・カラーにより概ね16万円〜29万円（税込）です。ワクチン接種・健康診断・血統書などを含みます。詳細はLINEでお問い合わせください。"),

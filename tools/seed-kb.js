...
const CHUNKS = {
  ...
  'kb:boarding':
    `福楽ペットは第一種動物取扱業の保管220012Bに基づき、完全予約制で猫と登録対象小動物を預かる。対象は猫、うさぎ、ハムスター、マウス、ラット、モルモット、デグー、チンチラ、フクロモモンガ、ヤマネ、ヘビ。種類と健康状態は予約前に個別確認し、犬は現在受け付けていない。猫は1泊4,800円、うさぎ・小動物は1泊1,500円から、ハムスター等は1泊500円から。猫のシャンプー・基本ケアは短毛4,000円、長毛6,000円。日程加算・長期料金・割引を含む概算は https://fuluckpet.com/boarding/ と https://fuluckpet.com/boarding/estimate.html 、猫の基本ケアは https://fuluckpet.com/grooming/ を確認し、正式料金はLINE相談後に確定する。`,
